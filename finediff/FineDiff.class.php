...
require_once(dirname(__FILE__) . '/' . "FineDiffInsertOp.class.php");
require_once(dirname(__FILE__) . '/' . "FineDiffCopyOp.class.php");
require_once(dirname(__FILE__) . '/' . "FineDiffReplaceOp.class.php");
require_once(dirname(__FILE__) . '/' . "FineDiffDeleteOp.class.php");
...
class FineDiff 
{
  ...
  public function renderDiffToHTML() 
  {
	...
	*/
	...
	public static $paragraphGranularity = array(FineDiff::paragraphDelimiters);
	public static $sentenceGranularity = array(FineDiff::paragraphDelimiters,FineDiff::sentenceDelimiters);
	public static $wordGranularity = array(FineDiff::paragraphDelimiters,FineDiff::sentenceDelimiters,FineDiff::wordDelimiters);
	public static $characterGranularity = array(FineDiff::paragraphDelimiters,FineDiff::sentenceDelimiters,FineDiff::wordDelimiters,FineDiff::characterDelimiters);
